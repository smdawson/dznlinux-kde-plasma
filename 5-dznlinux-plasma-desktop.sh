...
##########################################################
#                                                        #
#          DZN-Linux-Plasma desktop script               #
...
##########################################################
#  +FIRST  : sudo chmod +x dznlinux-plasma-desktop.sh    #
#                (Give EXEC Access To Script)            #
#  +TO RUN    : ./dznlinux-plasma-desktop.sh             #
##########################################################
#                                                        #
...
dznlinux-config-plasma-git
dznlinux-plasma-git
dznlinux-kvantum-git
zsh
zsh-completions
...
end_category DZN-Linux-Desktop
